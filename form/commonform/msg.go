...
var MsgRequired = ui.NewMessage("herbgo.form", "%[1]s is required.")

//MsgDuplicated messages that shows field is  duplicated.
var MsgDuplicated = ui.NewMessage("herbgo.form", " %[1]s is duplicated.")

//MsgInvalide messages that shows field is  invalid.
var MsgInvalide = ui.NewMessage("herbgo.form", " %[1]s is invalid.")

//MsgNotMatch messages that shows field is  not match.
var MsgNotMatch = ui.NewMessage("herbgo.form", "%[1]s is not match.")

//MsgIncorrect messages that shows field is  incorrect.
var MsgIncorrect = ui.NewMessage("herbgo.form", "%[1]s is incorrect.")
...
func NewFormatWrongMsg(format string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", "%[1]s format wrong(correct format is '{{format}}'.", map[string]string{"format": format})
}
...
func NewTooSmallMsg(min string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", "%[1]s is too small (minimum is {{min}}).", map[string]string{"min": min})
}
...
func NewTooBigMsg(max string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", "%[1]s is too big (maximum is {{max}}).", map[string]string{"max": max})
}
...
func NewTooShortMsg(min string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", "%[1]s is too short (minimum is {{min}} characters).", map[string]string{"min": min})
}
...
func NewTooLongMsg(max string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", "%[1]s is too long (maximum is {{max}} characters).", map[string]string{"max": max})
}
...
func NewWrongLengthMsg(length string) *ui.TemplateMessage {
	return ui.NewTemplateMessage("herbgo.form", " %[1]s is of the wrong length (should be {{length}} characters).", map[string]string{"length": length})
}
